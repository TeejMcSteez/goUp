...
function Card({ service }) {
    ...
    const [showFullHttpResponse, setShowFullHttpResponse] = useState(false); // New state for collapsing long HTTP responses

    const toggleApiResponse = () => {
        setShowApiResponse(!showApiResponse);
    };

    const toggleFullHttpResponse = () => { // New toggle function
        ...
        <div className="card">
            ...
            {isLongHttpResponse ? (
                <>
                    ...
                    {showFullHttpResponse && (
                        <div className="svcHttpRes">{response}</div>
                    )}
                </>
            ) : (
