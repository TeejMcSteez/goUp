import { useState, useEffect, lazy, Suspense, Component, type ReactNode, type ComponentType } from "react";
import Header from "../Header";
import Navigation from "./Navigation";

const nullModule: { default: ComponentType } = { default: () => null };
const OverviewView = lazy(() => import("../views/OverviewView").catch(() => nullModule));
const ServicesView = lazy(() => import("../views/ServicesView").catch(() => nullModule));
const AnalyticsView = lazy(() => import("../views/AnalyticsView").catch(() => nullModule));
const SettingsView = lazy(() => import("../views/SettingsView").catch(() => nullModule));
